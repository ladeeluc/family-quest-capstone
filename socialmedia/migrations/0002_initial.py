...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='target_post',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='post_reactions', to='socialmedia.post'),
        ),
        migrations.AddField(
            model_name='messagenotification',
            name='target_message',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='message_notifications', to='socialmedia.message'),
        ),
        migrations.AddField(
            model_name='commentreaction',
            name='target_comment',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comment_reactions', to='socialmedia.comment'),
        ),
        migrations.AddField(
            model_name='commentnotification',
            name='target_comment',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comment_notifications', to='socialmedia.comment'),
        ),
    ]
